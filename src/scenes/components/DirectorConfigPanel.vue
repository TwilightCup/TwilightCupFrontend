...
const fields: Field[] = [
  ...
  { key: "embedA", label: t("scenes.edit.embedA"), placeholder: "B站房间号/直播间链接 或 youtube.com/embed/..." },
  { key: "embedB", label: t("scenes.edit.embedB"), placeholder: "B站房间号/直播间链接 或 youtube.com/embed/..." },
];
